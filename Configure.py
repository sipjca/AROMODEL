...
# Local Paths
Aromodel_Path = "/Users/cjpais/code/AROMODEL"
Template_Path = Aromodel_Path + "/Templates/"


# Remote Paths
Comet_Login = "cjpais@comet.sdsc.edu"
Comet_Path = "/oasis/scratch/comet/cjpais/temp_project/aromodel_runs/%s" # % Directory_Name
